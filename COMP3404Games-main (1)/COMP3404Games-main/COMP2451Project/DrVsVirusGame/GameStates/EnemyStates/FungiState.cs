...
{
    /// <summary>
    /// A Class that represents the Fungi's state
    /// </summary>
    class FungiState : DrVsVirusState
    {
        // DECLARE a new string called _identifier
        private string _identifier;

        /// <summary>
        /// The recommended constructor for FungiState
        /// </summary>
        /// <param name="pIdentifier">The Default identifier string</param>
        public FungiState(string pIdentifier)
        {
